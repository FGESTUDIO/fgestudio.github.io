...
Object.assign(translations.cn, {
  ...
  "metaDescription.home": "{cnName}（FGESTUDIO / {company}）是来自马来西亚的线上创意工作室，提供平面设计服务，并与游戏内容创作者合作经营频道。",
  "metaTitle.design": "马来西亚平面设计服务 | {cnName}（FGESTUDIO）",
  "metaDescription.design": "{cnName}（FGESTUDIO / {company}）为商家与内容创作者提供海报、社媒贴文、广告图、Banner、名片和 YouTube 缩略图。",
  "metaTitle.mcn": "游戏创作者合作与频道支持 | {cnName}（FGESTUDIO）",
  "metaDescription.mcn": "{cnName}（FGESTUDIO / {company}）与游戏内容创作者一起整理频道定位、视觉包装、缩略图、内容栏目与商业合作资料。",
  "metaTitle.about": "关于{cnName}（FGESTUDIO）| 马来西亚线上创意工作室",
  "metaDescription.about": "认识{cnName}（FGESTUDIO / {company}）：来自马来西亚、提供平面设计服务并与游戏内容创作者合作的线上创意工作室。",

...
let translations = {
  cn: {
    ...
    "metaTitle.mcn": "{company} | 游戏创作者 MCN 孵化",
    "metaDescription.mcn": "{company} 提供游戏内容创作者 MCN 孵化、频道包装、内容方向、缩略图策略与成长支持。",
    "metaTitle.about": "{company} | 关于公司",
    "metaDescription.about": "了解 {company}：一个结合平面设计服务与游戏内容创作者 MCN 孵化的线上工作室。",
    "whatsappMessage.design": "你好，我想了解 {short} 的平面设计服务。",
    ...
    "contact.kicker": "联系我们",
    "contact.design.title": "告诉我们你需要什么设计，我们会先帮你整理方向。",
    "contact.design.copy": "目前我们是线上工作室，不放实体地址。你可以通过 WhatsApp、Facebook、Instagram 或 Email 联系我们。",
  ...
  en: {
    ...
    "metaDescription.design": "{company} provides posters, social media posts, ad creatives, banners, business cards, YouTube thumbnails, and monthly graphic design packages.",
    "metaTitle.mcn": "{company} | Gaming Creator MCN Incubation",
    "metaDescription.mcn": "{company} supports gaming creators with MCN incubation, channel branding, content direction, thumbnail strategy, and growth support.",
    "metaTitle.about": "{company} | About",
    "metaDescription.about": "Learn about {company}, an online studio for graphic design services and gaming creator MCN incubation.",
    "whatsappMessage.design": "Hi, I would like to ask about {short} graphic design services.",
    ...
    "contact.design.title": "Tell us what design you need, and we will help shape the direction.",
    "contact.design.copy": "We are currently an online studio, so no physical address is shown. Contact us through WhatsApp, Facebook, Instagram, or Email.",
  ...
  bm: {
    ...
    "metaDescription.design": "{company} menyediakan poster, hantaran media sosial, grafik iklan, banner, kad nama, thumbnail YouTube, dan pakej reka bentuk bulanan.",
    "metaTitle.mcn": "{company} | Inkubasi MCN Pencipta Gaming",
    "metaDescription.mcn": "{company} menyokong pencipta gaming dengan inkubasi MCN, penjenamaan channel, arah kandungan, strategi thumbnail, dan sokongan pertumbuhan.",
    "metaTitle.about": "{company} | Tentang Syarikat",
    "metaDescription.about": "Kenali {company}, studio online untuk servis reka bentuk grafik dan inkubasi MCN pencipta gaming.",
    "whatsappMessage.design": "Hai, saya ingin bertanya tentang servis reka bentuk grafik {short}.",
    ...
    "contact.design.title": "Beritahu kami reka bentuk yang anda perlukan, dan kami bantu susun arahnya.",
    "contact.design.copy": "Buat masa ini kami ialah studio online, jadi alamat fizikal tidak dipaparkan. Hubungi kami melalui WhatsApp, Facebook, Instagram, atau Email.",

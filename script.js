...
let translations = {
  cn: {
    ...
    "metaDescription.mcn": "{company}，简称 FGESTUDIO，提供游戏内容创作者 MCN 孵化、频道包装、内容方向、缩略图策略与成长支持。",
    "metaTitle.about": "{company} (FGESTUDIO) | 关于公司",
    "metaDescription.about": "了解 {company}，简称 FGESTUDIO，中文名{cnName}：一个结合平面设计服务与游戏内容创作者 MCN 孵化的线上工作室。",
    ...
    "hero.about.kicker": "关于 FGESTUDIO",
    "hero.about.title": "一个线上创意工作室，分成两个清楚的业务方向。",
    "hero.about.slogan": "平面设计服务面向商家，MCN 孵化面向游戏内容创作者。",
    "hero.about.copy": "我们把商业视觉制作和创作者成长支持分开呈现，让不同需求的人可以更快找到自己需要的服务。",
    ...
    "portfolio.title": "按实际服务分类的概念设计展示。",
    "portfolio.copy": "以下为方便后续替换真实作品而建立的展示位置；目前均标注为概念设计。",
    "portfolio.concept": "概念设计",
    "portfolio.inquiry": "询问此服务",
    "portfolio.businessCard.alt": "名片设计 concept placeholder",
    "portfolio.businessCard.type": "名片设计",
    "portfolio.businessCard.title": "名片设计｜RM50",
    "portfolio.businessCard.copy": "简洁专业的个人与商业名片版面设计。",
    "portfolio.businessCard.whatsapp": "您好，我想咨询名片设计服务。",
    "portfolio.socialPost.alt": "自媒体帖子设计 concept placeholder",
    "portfolio.socialPost.type": "自媒体帖子设计",
    "portfolio.socialPost.title": "自媒体帖子设计｜RM80",
    "portfolio.socialPost.copy": "适用于 Facebook、Instagram 等平台的宣传内容设计。",
    "portfolio.socialPost.whatsapp": "您好，我想咨询自媒体帖子设计服务。",
    "portfolio.poster.alt": "海报设计 concept placeholder",
    "portfolio.poster.type": "海报设计",
    "portfolio.poster.title": "海报设计｜RM120",
    "portfolio.poster.copy": "适用于促销、活动、餐饮与服务宣传的海报设计。",
    "portfolio.poster.whatsapp": "您好，我想咨询海报设计服务。",
    "portfolio.banner.alt": "横幅设计 concept placeholder",
    "portfolio.banner.type": "横幅设计",
    "portfolio.banner.title": "横幅设计｜RM150",
    "portfolio.banner.copy": "适用于网站、Facebook 封面、活动与广告用途的横幅设计。",
    "portfolio.banner.whatsapp": "您好，我想咨询横幅设计服务。",
  },
  en: {
    ...
    "portfolio.title": "Concept displays organised around our actual design services.",
    "portfolio.copy": "These clearly marked concept projects use dedicated slots so real work can be replaced later.",
    "portfolio.concept": "Concept Project",
    "portfolio.inquiry": "Ask about this service",
    "portfolio.businessCard.alt": "Business Card Design concept placeholder",
    "portfolio.businessCard.type": "Business Card Design",
    "portfolio.businessCard.title": "Business Card Design | RM50",
    "portfolio.businessCard.copy": "Clean, professional layout design for personal and business cards.",
    "portfolio.businessCard.whatsapp": "Hi, I would like to ask about Business Card Design.",
    "portfolio.socialPost.alt": "Social Media Post Design concept placeholder",
    "portfolio.socialPost.type": "Social Media Post Design",
    "portfolio.socialPost.title": "Social Media Post Design | RM80",
    "portfolio.socialPost.copy": "Promotional content design for Facebook, Instagram, and similar platforms.",
    "portfolio.socialPost.whatsapp": "Hi, I would like to ask about Social Media Post Design.",
    "portfolio.poster.alt": "Poster Design concept placeholder",
    "portfolio.poster.type": "Poster Design",
    "portfolio.poster.title": "Poster Design | RM120",
    "portfolio.poster.copy": "Poster design for promotions, events, food and beverage, and service marketing.",
    "portfolio.poster.whatsapp": "Hi, I would like to ask about Poster Design.",
    "portfolio.banner.alt": "Banner Design concept placeholder",
    "portfolio.banner.type": "Banner Design",
    "portfolio.banner.title": "Banner Design | RM150",
    "portfolio.banner.copy": "Banner design for websites, Facebook covers, events, and advertising.",
    "portfolio.banner.whatsapp": "Hi, I would like to ask about Banner Design.",
  },
  bm: {
    ...
    "portfolio.kicker": "Portfolio",
    "portfolio.title": "Paparan projek konsep yang disusun mengikut servis reka bentuk sebenar kami.",
    "portfolio.copy": "Semua projek ini ditanda jelas sebagai konsep dan mempunyai ruang khas untuk diganti dengan karya sebenar nanti.",
    "portfolio.concept": "Projek Konsep",
    "portfolio.inquiry": "Tanya servis ini",
    "portfolio.businessCard.alt": "Reka Bentuk Kad Nama concept placeholder",
    "portfolio.businessCard.type": "Reka Bentuk Kad Nama",
    "portfolio.businessCard.title": "Reka Bentuk Kad Nama | RM50",
    "portfolio.businessCard.copy": "Reka letak kad nama peribadi dan perniagaan yang ringkas serta profesional.",
    "portfolio.businessCard.whatsapp": "Hai, saya ingin bertanya tentang servis reka bentuk kad nama.",
    "portfolio.socialPost.alt": "Reka Bentuk Kiriman Media Sosial concept placeholder",
    "portfolio.socialPost.type": "Reka Bentuk Kiriman Media Sosial",
    "portfolio.socialPost.title": "Reka Bentuk Kiriman Media Sosial | RM80",
    "portfolio.socialPost.copy": "Reka bentuk kandungan promosi untuk Facebook, Instagram, dan platform seumpamanya.",
    "portfolio.socialPost.whatsapp": "Hai, saya ingin bertanya tentang servis reka bentuk kiriman media sosial.",
    "portfolio.poster.alt": "Reka Bentuk Poster concept placeholder",
    "portfolio.poster.type": "Reka Bentuk Poster",
    "portfolio.poster.title": "Reka Bentuk Poster | RM120",
    "portfolio.poster.copy": "Reka bentuk poster untuk promosi, acara, makanan dan minuman, serta servis.",
    "portfolio.poster.whatsapp": "Hai, saya ingin bertanya tentang servis reka bentuk poster.",
    "portfolio.banner.alt": "Reka Bentuk Sepanduk concept placeholder",
    "portfolio.banner.type": "Reka Bentuk Sepanduk",
    "portfolio.banner.title": "Reka Bentuk Sepanduk | RM150",
    "portfolio.banner.copy": "Reka bentuk sepanduk untuk laman web, cover Facebook, acara, dan pengiklanan.",
    "portfolio.banner.whatsapp": "Hai, saya ingin bertanya tentang servis reka bentuk sepanduk.",
  },
};
...
function getPackageWhatsappMessage(link, lang) {
  const serviceKey = link.dataset.serviceInquiry;
  if (serviceKey) return getText(lang, `portfolio.${serviceKey}.whatsapp`);

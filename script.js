...
let translations = {
  cn: {
    "metaTitle.design": "{company} (FGES / FGESTUDIO) | 平面设计服务",
    "metaDescription.design": "{company}，简称 FGES / FGESTUDIO，中文名{cnName}，提供海报、社交媒体帖子、广告图、banner、名片、YouTube 缩略图与月配套平面设计服务。",
    "metaTitle.mcn": "{company} (FGES / FGESTUDIO) | 游戏创作者 MCN 孵化",
    "metaDescription.mcn": "{company}，简称 FGES / FGESTUDIO，提供游戏内容创作者 MCN 孵化、频道包装、内容方向、缩略图策略与成长支持。",
    "metaTitle.about": "{company} (FGES / FGESTUDIO) | 关于公司",
    "metaDescription.about": "了解 {company}，简称 FGES / FGESTUDIO，中文名{cnName}：一个结合平面设计服务与游戏内容创作者 MCN 孵化的线上工作室。",
    ...
    "aboutTimeline.copy": "FGES 会把每个阶段的业务方向分清楚，让客户、创作者和未来合作伙伴都能更快理解我们正在做什么、接下来期待做什么。",
  ...
  en: {
    "metaTitle.design": "{company} (FGES / FGESTUDIO) | Graphic Design Services",
    "metaDescription.design": "{company}, also known as FGES / FGESTUDIO / {cnName}, provides posters, social media posts, ad creatives, banners, business cards, YouTube thumbnails, and monthly graphic design packages.",
    "metaTitle.mcn": "{company} (FGES / FGESTUDIO) | Gaming Creator MCN Incubation",
    "metaDescription.mcn": "{company}, also known as FGES / FGESTUDIO, supports gaming creators with MCN incubation, channel branding, content direction, thumbnail strategy, and growth support.",
    "metaTitle.about": "{company} (FGES / FGESTUDIO) | About",
    "metaDescription.about": "Learn about {company}, also known as FGES / FGESTUDIO / {cnName}, an online studio for graphic design services and gaming creator MCN incubation.",
    ...
    "aboutTimeline.copy": "FGES keeps each stage of the business clearly separated, so clients, creators, and future partners can quickly understand what we do now and what we are looking forward to next.",
  ...
  bm: {
    "metaTitle.design": "{company} (FGES / FGESTUDIO) | Servis Reka Bentuk Grafik",
    "metaDescription.design": "{company}, juga dikenali sebagai FGES / FGESTUDIO / {cnName}, menyediakan poster, hantaran media sosial, grafik iklan, banner, kad nama, thumbnail YouTube, dan pakej reka bentuk bulanan.",
    "metaTitle.mcn": "{company} (FGES / FGESTUDIO) | Inkubasi MCN Pencipta Gaming",
    "metaDescription.mcn": "{company}, juga dikenali sebagai FGES / FGESTUDIO, menyokong pencipta gaming dengan inkubasi MCN, penjenamaan channel, arah kandungan, strategi thumbnail, dan sokongan pertumbuhan.",
    "metaTitle.about": "{company} (FGES / FGESTUDIO) | Tentang Syarikat",
    "metaDescription.about": "Kenali {company}, juga dikenali sebagai FGES / FGESTUDIO / {cnName}, studio online untuk servis reka bentuk grafik dan inkubasi MCN pencipta gaming.",
    ...
    "hero.about.kicker": "Tentang FGES",
    ...
    "aboutTimeline.copy": "FGES memisahkan setiap fasa bisnes dengan jelas supaya pelanggan, pencipta, dan rakan kerjasama masa depan boleh memahami apa yang kami lakukan sekarang dan apa yang kami nantikan seterusnya.",
